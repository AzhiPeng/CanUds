...
{
    public partial class FrmDownloadFromMes :Skin_VS
    {
        public FrmDownloadFromMes()
        {
            InitializeComponent();
        }
        ...
        private void FrmDownloadFromMes_Load(object sender, EventArgs e)
        {
            {
            ...
            if (itm != null)
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        sf.InitialDirectory = path + @"\" + @"产品测试项配置";
