...
{
    // 2026-05-01: CAN监控公共消息总线（发布-订阅）。
    public static class CanMessageBus
    {
        public sealed class RawCanMessage
        {
        ...
        public static event Action<RawCanMessage> MessagePublished;

        public static void Publish(RawCanMessage message)
        {
            if (message == null)
            {
                return;
    ...
    public partial class FrmCanMessage : Skin_VS
    {
