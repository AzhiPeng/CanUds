...
namespace Go
{
    ...
    public class Map<TKey, TValue>
    {
        ...
        {
            return new MapNode<TKey, TValue>() { key = key, value = value, color = rb_color.red };
        }
        ...
        bool is_nil(MapNode<TKey, TValue> node)
        {
            return node == _head;
        }
        ...
        MapNode<TKey, TValue> max(MapNode<TKey, TValue> pNode)
        {
        ...
        MapNode<TKey, TValue> min(MapNode<TKey, TValue> pNode)
        {
        ...
        MapNode<TKey, TValue> next(MapNode<TKey, TValue> ptr)
        {
            if (is_nil(ptr))
            {
                return ptr;
        ...
        MapNode<TKey, TValue> previous(MapNode<TKey, TValue> ptr)
        {
            if (is_nil(ptr))
            {
                return ptr;
        ...
        void erase(MapNode<TKey, TValue> rootNode)
        {
        ...
        {
            MapNode<TKey, TValue> node = FindFirst(key);
            if (null == node)
            {
                value = default;
                return false;
