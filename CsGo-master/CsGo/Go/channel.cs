...
namespace Go
{
    ...
    public abstract class chan_base
    {
        ...
        public shared_strand strand { get { return _strand; } }

        public void async_clear(Action ntf)
        {
            if (_strand.running_in_this_thread())
                if (!_mustTick) async_clear_(ntf);
                else _strand.add_last(() => async_clear_(ntf));
        ...
        public void async_close(Action ntf, bool isClear = false)
        {
            if (_strand.running_in_this_thread())
                ...
                else _strand.add_last(() => async_close_(ntf));
        ...
        public void async_cancel(Action ntf, bool isClear = false)
        {
            if (_strand.running_in_this_thread())
                ...
                else _strand.add_last(() => async_cancel_(ntf, isClear));
        ...
        public void async_append_recv_notify(Action<chan_state> ntf, chan_notify_sign ntfSign, int ms = -1)
        {
            if (_strand.running_in_this_thread())
                ...
                else _strand.add_last(() => async_append_recv_notify_(ntf, ntfSign, ms));
        ...
        public void async_remove_recv_notify(Action<chan_state> ntf, chan_notify_sign ntfSign)
        {
            if (_strand.running_in_this_thread())
                ...
                else _strand.add_last(() => async_remove_recv_notify_(ntf, ntfSign));
        ...
        public void async_append_send_notify(Action<chan_state> ntf, chan_notify_sign ntfSign, int ms = -1)
        {
            if (_strand.running_in_this_thread())
                ...
                else _strand.add_last(() => async_append_send_notify_(ntf, ntfSign, ms));
        ...
        public void async_remove_send_notify(Action<chan_state> ntf, chan_notify_sign ntfSign)
        {
            if (_strand.running_in_this_thread())
                ...
                else _strand.add_last(() => async_remove_send_notify_(ntf, ntfSign));
        ...
        public void async_append_recv_notify(Action<chan_state> ntf, broadcast_token token, chan_notify_sign ntfSign, int ms = -1)
        {
            if (_strand.running_in_this_thread())
                ...
                else _strand.add_last(() => async_append_recv_notify_(ntf, token, ntfSign, ms));
    ...
    public abstract class chan<T> : chan_base
    {
        ...
        public void async_send(Action<chan_send_wrap> ntf, T msg, chan_notify_sign ntfSign = null)
        {
            if (_strand.running_in_this_thread())
                ...
                else _strand.add_last(() => async_send_(ntf, msg, ntfSign));
        ...
        public void async_recv(Action<chan_recv_wrap<T>> ntf, chan_notify_sign ntfSign = null)
        {
            if (_strand.running_in_this_thread())
                ...
                else _strand.add_last(() => async_recv_(ntf, ntfSign));
        ...
        public void async_try_send(Action<chan_send_wrap> ntf, T msg, chan_notify_sign ntfSign = null)
        {
            if (_strand.running_in_this_thread())
                ...
                else _strand.add_last(() => async_try_send_(ntf, msg, ntfSign));
        ...
        public void async_try_recv(Action<chan_recv_wrap<T>> ntf, chan_notify_sign ntfSign = null)
        {
            if (_strand.running_in_this_thread())
                ...
                else _strand.add_last(() => async_try_recv_(ntf, ntfSign));
        ...
        public void async_timed_send(int ms, Action<chan_send_wrap> ntf, T msg, chan_notify_sign ntfSign = null)
        {
            if (_strand.running_in_this_thread())
                ...
                else _strand.add_last(() => async_timed_send_(ms, ntf, msg, ntfSign));
        ...
        public void async_timed_recv(int ms, Action<chan_recv_wrap<T>> ntf, chan_notify_sign ntfSign = null)
        {
            if (_strand.running_in_this_thread())
                ...
                else _strand.add_last(() => async_timed_recv_(ms, ntf, ntfSign));
        ...
        public void async_try_recv_and_append_notify(Action<chan_recv_wrap<T>> cb, Action<chan_state> msgNtf, chan_notify_sign ntfSign, int ms = -1)
        {
            if (_strand.running_in_this_thread())
                ...
                else _strand.add_last(() => async_try_recv_and_append_notify_(cb, msgNtf, ntfSign, ms));
        ...
        public void async_try_send_and_append_notify(Action<chan_send_wrap> cb, Action<chan_state> msgNtf, chan_notify_sign ntfSign, T msg, int ms = -1)
        {
            if (_strand.running_in_this_thread())
                ...
                else _strand.add_last(() => async_try_send_and_append_notify_(cb, msgNtf, ntfSign, msg, ms));
        ...
        public void async_recv(Action<chan_recv_wrap<T>> ntf, broadcast_token token, chan_notify_sign ntfSign = null)
        {
            if (_strand.running_in_this_thread())
                ...
                else _strand.add_last(() => async_recv_(ntf, token, ntfSign));
        ...
        public void async_try_recv(Action<chan_recv_wrap<T>> ntf, broadcast_token token, chan_notify_sign ntfSign = null)
        {
            if (_strand.running_in_this_thread())
                ...
                else _strand.add_last(() => async_try_recv_(ntf, token, ntfSign));
        ...
        public void async_timed_recv(int ms, Action<chan_recv_wrap<T>> ntf, broadcast_token token, chan_notify_sign ntfSign = null)
        {
            if (_strand.running_in_this_thread())
                ...
                else _strand.add_last(() => async_timed_recv_(ms, ntf, token, ntfSign));
        ...
        public void async_try_recv_and_append_notify(Action<chan_recv_wrap<T>> cb, Action<chan_state> msgNtf, broadcast_token token, chan_notify_sign ntfSign, int ms = -1)
        {
            if (_strand.running_in_this_thread())
                ...
                else _strand.add_last(() => async_try_recv_and_append_notify_(cb, msgNtf, token, ntfSign, ms));
    ...
    public class unlimit_chan<T> : chan<T>
    {
        ...
        public void async_first(Action<chan_recv_wrap<T>> ntf, chan_notify_sign ntfSign = null)
        {
            if (_strand.running_in_this_thread())
                ...
                else _strand.add_last(() => async_first_(ntf, ntfSign));
            else _strand.post(() => async_first_(ntf, ntfSign));
        }
        ...
        public void async_last(Action<chan_recv_wrap<T>> ntf, chan_notify_sign ntfSign = null)
        {
            if (_strand.running_in_this_thread())
                ...
                else _strand.add_last(() => async_last_(ntf, ntfSign));
            else _strand.post(() => async_last_(ntf, ntfSign));
        }
    ...
    public class limit_chan<T> : chan<T>
    {
        ...
        public void async_force_send(Action<chan_state, bool, T> ntf, T msg)
        {
            if (_strand.running_in_this_thread())
                ...
                else _strand.add_last(() => async_force_send_(ntf, msg));
        ...
        public void async_timed_force_send(int ms, Action<chan_state, bool, T> ntf, T msg, chan_notify_sign ntfSign = null)
        {
            if (_strand.running_in_this_thread())
                ...
                else _strand.add_last(() => async_timed_force_send_(ms, ntf, msg, ntfSign));
            else _strand.post(() => async_timed_force_send_(ms, ntf, msg, ntfSign));
        }
    ...
    public class csp_chan<R, T> : chan_base
    {
        ...
        public void async_send(int invokeMs, Action<csp_invoke_wrap<R>> ntf, T msg, chan_notify_sign ntfSign = null)
        {
            if (_strand.running_in_this_thread())
                ...
                else _strand.add_last(() => async_send_(invokeMs, ntf, msg, ntfSign));
        ...
        public void async_try_send(int invokeMs, Action<csp_invoke_wrap<R>> ntf, T msg, chan_notify_sign ntfSign = null)
        {
            if (_strand.running_in_this_thread())
                ...
                else _strand.add_last(() => async_try_send_(invokeMs, ntf, msg, ntfSign));
        ...
        public void async_timed_send(int ms, int invokeMs, Action<csp_invoke_wrap<R>> ntf, T msg, chan_notify_sign ntfSign = null)
        {
            if (_strand.running_in_this_thread())
                ...
                else _strand.add_last(() => async_timed_send_(ms, invokeMs, ntf, msg, ntfSign));
        ...
        private void async_recv_(Action<csp_wait_wrap<R, T>> ntf, chan_notify_sign ntfSign)
        {
            ...
            if (_tempMsg._has)
            {
                ...
                _tempMsg.cancel();
                _sendQueue.RemoveFirst().Invoke(chan_state.ok);
                ntf(new csp_wait_wrap<R, T> { state = chan_state.ok, msg = msg._msg, result = new csp_result<R>(msg._invokeMs, msg._notify) });
            }
            else if (_closed)
            {
        ...
        private void async_try_recv_and_append_notify_(Action<csp_wait_wrap<R, T>> cb, Action<chan_state> msgNtf, chan_notify_sign ntfSign, int ms)
        {
            ...
            if (_tempMsg._has)
            {
                ...
                cb(new csp_wait_wrap<R, T> { state = chan_state.ok, msg = msg._msg, result = new csp_result<R>(msg._invokeMs, msg._notify) });
            }
            else if (_closed)
            {
                msgNtf(chan_state.closed);
    ...
    public class csp_result<R>
    {
        int _ms;
        async_timer _timer;
        Action<csp_invoke_wrap<R>> _notify;
        ...
        internal void start_invoke_timer(generator host)
        {
            if (_ms >= 0)
            {
                _timer = new async_timer(host.strand);
                _timer.timeout(_ms, () => cancel()?.Invoke(new csp_invoke_wrap<R> { state = chan_state.csp_overtime }));
            }
        }

        private Action<csp_invoke_wrap<R>> cancel()
        {
            async_timer timer;
            Action<csp_invoke_wrap<R>> ntf;
            lock (this)
            {
                timer = _timer;
                _timer = null;
            ...
            if (null != timer)
            {
                if (timer.self_strand().running_in_this_thread())
                {
                    timer.cancel();
                }
                else
                {
                    timer.self_strand().dispatch(() => timer.cancel());
                }
            }
            return ntf;
        }
        ...
        {
            Action<csp_invoke_wrap<R>> ntf = cancel();
            if (null == ntf)
            {
                return false;
            }
